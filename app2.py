...
from htmlTemplates import css, bot_template, user_template, page_bg_img, bot_Search_template
...
def main():
    ...
    for message in st.session_state.chat_history:
        if isinstance(message, AIMessage):
            st.write(bot_Search_template.replace("{{MSG}}", message.content), unsafe_allow_html=True)
